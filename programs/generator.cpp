...
void copy_resource_files(Generator &generator)
{
   ...
   std::filesystem::copy(resource_file_folder + "fonts/RobotoCondensed-Regular.ttf", new_project_data_folder + "fonts/RobotoCondensed-Regular.ttf");
   std::filesystem::copy(resource_file_folder + "fonts/RobotoCondensed-Regular.ttf", new_project_fixtures_folder + "fonts/RobotoCondensed-Regular.ttf");
