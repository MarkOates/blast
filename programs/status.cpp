...
int main(int argc, char **argv)
{
   ...
   projects = {
      ...
      { "AllegroPrims", { false, ProjectStatus("AllegroPrims", base_dir) } },
      { "Timeline", { false, ProjectStatus("Timeline", base_dir) } },
      ...
      { "BulletPhysics",      { false, ProjectStatus("BulletPhysics", base_dir) } },
