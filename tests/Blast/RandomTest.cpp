...
#include <algorithm>
#include <iomanip>
//#include <Blast/Testing/CustomComparison.hpp>


TEST(Blast_RandomTest, gets_the_current_seed)
{
   Blast::Random number_generator = Blast::Random(123);

   ASSERT_EQ(123, number_generator.get_seed());
}


TEST(Blast_RandomTest, sets_the_current_seed)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_bool__returns_random_booleans)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_sign__returns_the_number_1_randomly_either_positive_or_negative)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_sign__will_return_repeatable_values_given_the_same_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
...
TEST(Blast_RandomTest, get_random_int__only_returns_integers_within_the_bounds_inclusive)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_double__only_returns_doubles_within_the_bounds_inclusive)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_letter__returns_a_random_uppercase_character)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_letter__with_lowercase_set_to_true__returns_a_random_uppercase_character)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_letter__will_return_repeatable_values_given_the_same_seed)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_letter_or_number__returns_repeatable_values_given_the_same_seed)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_string__returns_repeatable_values_given_the_same_seed)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_float__only_returns_floats_within_the_bounds_inclusive)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_element__returns_a_random_element_from_the_vector)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, get_random_element__returns_a_repeatable_selection_of_elements_given_a_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
   std::vector<int> elements_to_pick_from = { 18, 42, 256, 9, 11 };
...
TEST(Blast_RandomTest, shuffle_elements__will_randomize_the_order_of_the_elements_in_the_vector)
{
   Blast::Random number_generator = Blast::Random(123);
...
TEST(Blast_RandomTest, shuffle_elements__will_produce_a_reproducable_shuffling_given_the_same_seed)
{
   Blast::Random number_generator = Blast::Random(123456+7);
...
TEST(Blast_RandomTest, get_random_int__returns_a_repeatable_sequence_of_random_numbers_given_a_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
...
TEST(Blast_RandomTest, get_random_float__returns_a_repeatable_sequence_of_random_numbers_given_a_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
   const float min_random_num = 3.0;
   const float max_random_num = 5.0;
...
TEST(Blast_RandomTest, get_random_double__returns_a_repeatable_sequence_of_random_numbers_given_a_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
...
TEST(Blast_RandomTest, get_random_bool__returns_a_repeatable_sequence_of_random_booleans_given_a_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
...
TEST(Blast_RandomTest, roll_dice__returns_a_repeatable_sequence_of_random_rolls_given_a_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
...
TEST(Blast_RandomTest, get_one_in_chance__returns_a_repeatable_sequence_of_random_values_given_a_seed)
{
   Blast::Random number_generator = Blast::Random(123456);
