...
TEST(Blast_Quintessence_YAMLParsing_EnumClassParserTest, can_be_created_without_blowing_up)
{
   Blast::Quintessence::YAMLParsing::EnumClassParser enum_class_parser;
}


TEST(Blast_Quintessence_YAMLParsing_EnumClassParserTest,
   parse__will_return_an_enum_class_object_with_the_expected_values)
{
   ...
   Blast::Quintessence::YAMLParsing::EnumClassParser enum_class_parser(node);
   ...
   parse__when_both_a_name_key_and_a_class_key_are_defined__will_throw_an_error)
{
   ...
   EXPECT_THROW_WITH_MESSAGE(
      ...
      std::runtime_error,
      "[Blast::Quintessence::YAMLParsing::EnumClassParser::parse]: error: An enum cannot have both "
         "the \"name\" and \"class\" present. It must be one or neither."
   );
}


TEST(Blast_Quintessence_YAMLParsing_EnumClassParserTest, parse__when_a_class_is_not_present__does_not_throw_an_error)
{
...
TEST(Blast_Quintessence_YAMLParsing_EnumClassParserTest, parse__when_a_type_is_not_present__does_not_throw_an_error)
{
   std::string yaml_content = "enumerators: [ FOO, FOE, FUM ]\n";
   YAML::Node node = YAML::Load(yaml_content);
   Blast::Quintessence::YAMLParsing::EnumClassParser enum_class_parser(node);
...
TEST(Blast_Quintessence_YAMLParsing_EnumClassParserTest, parse__when_a_scope_is_not_present__does_not_throw_an_error)
{
   std::string yaml_content = "enumerators: [ FOO, FOE, FUM ]\n";
   YAML::Node node = YAML::Load(yaml_content);
   Blast::Quintessence::YAMLParsing::EnumClassParser enum_class_parser(node);
...
TEST(Blast_Quintessence_YAMLParsing_EnumClassParserTest, parse__when_enumerators_are_not_present__throws_an_error)
{
   std::string yaml_content = "class: \"FooBar\"\neyetems: [ FOO, FOE, FUM ]\n";
   YAML::Node node = YAML::Load(yaml_content);
   Blast::Quintessence::YAMLParsing::EnumClassParser enum_class_parser(node);
   ...
   validate_elements_are_unique__will_return_true_on_an_empty_vector)
{
  ...
  EXPECT_EQ(true, Blast::Quintessence::YAMLParsing::EnumClassParser::validate_elements_are_unique(empty_vector));
}
   ...
   validate_elements_are_unique__with_a_vector_with_unique_elements__will_return_true)
{
  ...
  EXPECT_EQ(true, Blast::Quintessence::YAMLParsing::EnumClassParser::validate_elements_are_unique(vector));
}
   ...
   validate_elements_are_unique__with_a_vector_that_does_not_contain_unique_elements__will_return_false)
{
  ...
  EXPECT_EQ(false, Blast::Quintessence::YAMLParsing::EnumClassParser::validate_elements_are_unique(vector));
}
