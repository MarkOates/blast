...
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", false, true, false, false, false);
}
...
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", false, false, false, false, false);
...
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", true, true, false, false, false);
...
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", true, false, false, false, false);
...
TEST(ClassAttributePropertiesTest, getter_ref_function_symbol__returns_the_symbol_used_for_the_getter_ref_function)
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", false, false, false, false, false);
...
TEST(ClassAttributePropertiesTest, getter_ref_function_declaration__formats_the_function_as_a_getter_ref_function_listed_in_a_class_declaration)
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", false, false, false, false, false);
...
TEST(ClassAttributePropertiesTest, getter_ref_function_declaration__formats_the_function_as_a_getter_ref_function_listed_in_a_static_class_declaration)
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", true, false, false, false, false);
...
TEST(ClassAttributePropertiesTest, getter_ref_function_definition__formats_the_function_as_a_getter_ref_function_listed_in_a_class_definition)
{
   Blast::Cpp::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", false, false, false, false, false);
