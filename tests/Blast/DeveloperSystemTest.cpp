...
TEST(Blast_DeveloperSystemTest, infer_projects_directory__will_return_the_expected_directory)
{
   Blast::DeveloperSystem developer_system;
#ifdef _WIN32
   std::string expected_directory = "/msys64/home/Mark/Repos/";
   EXPECT_EQ(expected_directory, developer_system.infer_projects_directory());
#elif __APPLE__ || __MACH__
