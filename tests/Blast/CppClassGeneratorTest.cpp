...
{
   Blast::CppClass cpp_class("Ascend");
   Blast::CppClassGenerator class_generator(cpp_class);
...
{
   Blast::CppClass cpp_class("Ascend", {}, { { "Action", "\"ascend_action\"", "private" }, { "Scriptable<Ascend>", "", "protected" } });
   Blast::CppClassGenerator class_generator(cpp_class);
...
{
   Blast::CppClass cpp_class("Happiness");
   Blast::CppClassGenerator class_generator(cpp_class);
