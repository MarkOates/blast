...
{
   Blast::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", false, true, false, false, false);
}
...
{
   Blast::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", false, false, false, false, false);
...
{
   Blast::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", true, true, false, false, false);
...
{
   Blast::ClassAttributeProperties attribute_properties("std::string", "my_variable", "\"Hello World!\"", true, false, false, false, false);
