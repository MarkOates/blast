...
{
   Blast::CommandLineFlaggedArgumentsParser parser(std::vector<std::string>{});
}


TEST_F(CommandLineFlaggedArgumentsParserTest, with_constructor_2__can_be_created)
{
   Blast::CommandLineFlaggedArgumentsParser parser(0, nullptr);
}


TEST_F(CommandLineFlaggedArgumentsParserTest, DISABLED_with_constructor_2__properly_parses_the_passed_arguments)
{
   // UNTESTED
}
