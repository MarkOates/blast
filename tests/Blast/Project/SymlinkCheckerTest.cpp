...
TEST(DISABLED_Blast_Project_SymlinkCheckerTest, is_symlink__returns_true_the_file_is_a_symlink)
{
...
TEST(DISABLED_Blast_Project_SymlinkCheckerTest, read_symlink_target__returns_the_target_of_the_symlink)
{
   std::string symlink_file = FIXTURE_PATH + "quintessence/ComponentWithExternalSymlink.q.yml";
   Blast::Project::SymlinkChecker symlink_checker(symlink_file);
