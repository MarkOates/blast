...
ComponentBasenameExtractor::ComponentBasenameExtractor(std::string filename)
   : filename(filename)
{
}


ComponentBasenameExtractor::~ComponentBasenameExtractor()
{
}


std::string ComponentBasenameExtractor::identify_file_type()
{
   return extract_component().first;
}

std::string ComponentBasenameExtractor::identify_component_basename()
{
   return extract_component().second;
}

std::pair<std::string, std::string> ComponentBasenameExtractor::extract_component()
{
