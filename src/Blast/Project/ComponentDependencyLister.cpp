...
std::vector<std::string> ComponentDependencyLister::list_component_dependency_names()
{
   if (!(component))
   {
      ...
      error_message << "[Blast::Project::ComponentDependencyLister::list_component_dependency_names]: error: guard \"component\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Blast::Project::ComponentDependencyLister::list_component_dependency_names]: error: guard \"component\" not met");
   }
...
std::string ComponentDependencyLister::get_component_quintessence_full_filename()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Blast::Project::ComponentDependencyLister::get_component_quintessence_full_filename]: error: guard \"component\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Blast::Project::ComponentDependencyLister::get_component_quintessence_full_filename]: error: guard \"component\" not met");
   }
