...
#include <Blast/Project/BasenameExtractor.hpp>
...
BasenameExtractor::BasenameExtractor(std::string filename)
   : filename(filename)
{
}


BasenameExtractor::~BasenameExtractor()
{
}


std::string BasenameExtractor::identify_file_type()
{
return extract_component().first;
}

std::string BasenameExtractor::identify_component_basename()
{
return extract_component().second;
}

std::pair<std::string, std::string> BasenameExtractor::extract_component()
{
