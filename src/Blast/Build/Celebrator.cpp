...
std::string Celebrator::generate_debug_banner(int width)
{
...
std::string Celebrator::generate_fail_banner(int width)
{
   std::vector<std::string> lines = {
     "|---------- ruler ----------------------------------------------------------------------------------------------|",
     "▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒",
...
std::string Celebrator::generate_built_banner(int width)
{
   std::string CONSOLE_COLOR_GREEN = "\033[1;32m";
   std::string CONSOLE_COLOR_BLUE = "\033[1;34m";
...
std::string Celebrator::generate_synced_banner(int width)
{
   std::vector<std::string> lines = {
     "|---------- ruler ----------------------------------------------------------------------------------------------|",
     "███▒ ██▒ █▒ █▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒ ▒█ ▒█ ▒██ ▒███",
