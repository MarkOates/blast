...
ifeq ($(OS),Windows_NT)
  ...
  WARNINGS_PROMOTED_TO_ERRORS_FLAGS=$(ERROR_IF_UNINITIALIZED) $(ERROR_IF_INCORRECT_RETURN_TYPE) $(ERROR_IF_CONSTRUCTOR_INIT_OUT_OF_ORDER) $(ERROR_IF_ACCIDENTAL_OVERLOAD) $(ERROR_IF_VIRTUAL_NOT_MARKED_OVERRIDE) $(ERROR_IF_MACRO_REDEFINED) $(ERROR_IF_ASSIGNMENT_IN_CONDITIONAL) $(ERROR_ON_HEADER_HYGINE) $(ERROR_IF_SELF_ASSIGNMENT_ON_FIELD) $(ERROR_IF_UNHANDLED_ENUMERATION_VALUE) $(ERROR_IF_MISSING_TERMINATING_CHARACTER)
